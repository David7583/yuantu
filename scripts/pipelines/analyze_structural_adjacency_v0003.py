#!/usr/bin/env python3
# ============================================================
# File: analyze_structural_adjacency_v0003.py
# 中文名: 结构邻接分析脚本
# Version: v0003
# Layer: execution
...
# alias: analyze_structural_adjacency_v0003
# family: analyze_structural_adjacency
# role: structural_adjacency_analysis
# version: v0003
# status: active
# entry_point: analyze_structural_adjacency_v0003.py
# input:
...
SCRIPT_NAME = "analyze_structural_adjacency_v0003.py"
...
def analyze_adjacency(
    ...
    meta = {
        ...
        "known_limitations": [
            "v0003 outputs per-container edges without global aggregation; aggregation is builder's responsibility.",
            "v0003 requires unit_id and unit_text in input; rows missing these fields are skipped.",
            "v0003 adjacency_count is always 1 per output row (one edge per container occurrence).",
            "v0003 direction is always 'forward', distance is always 1.",
        ],
        "v0003_changes": [
...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Analyze structural adjacency at segment level (v0003).",
    )
    ...
    parser.add_argument("--output", default=None, help="Output adjacency JSONL path (single-file mode).")
    parser.add_argument("--output-dir", default=None, help="Output directory for per-file adjacency JSONL (directory mode).")
